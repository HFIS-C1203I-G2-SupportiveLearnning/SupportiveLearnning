...
<html>
    <head>
        ...
        <title>Statistics Student Submitted</title>
    ...
    <body>
        <div class="main">
            ...
            <div id="body">
                ...
                <div>
                    <s:form action="reportBySubmitted.action" method="POST">
                        <table cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <s:select label="Status" list="mStatus" name="stdo.submitted" value="%{stdo.submitted}" cssClass="select"/>
